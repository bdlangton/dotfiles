...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(status custom_project context dir vcs)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(time background_jobs virtualenv rbenv rvm)
POWERLEVEL9K_VCS_GIT_HOOKS=(vcs-detect-changes git-untracked git-aheadbehind git-tagname git-stash git-remotebranch)

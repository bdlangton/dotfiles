...
for command in 'tldr', 'eslint', 'remark-lint', 'remark-cli', 'remark-preset-lint-recommended', 'prettier', 'prettier-plugin-elm', 'eslint-plugin-prettier', 'eslint-config-airbnb', 'stylelint', 'babel-eslint', 'elm-format', 'elm-test', 'elm-oracle'
do
